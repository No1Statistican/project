...
```
We can now graph these sentiments and see if there are 

Now we will run a regression to see if we can predict the sentiments of the polls. First I must combine the datasets into ratios I can work with
```{r}
